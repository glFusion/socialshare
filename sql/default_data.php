...
$_SQL_DATA['services'] = array(
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('AIM', 0, 1, 0, 'aim', 'Aol Instant Message Button');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Amazon Wish List', 0, 1, 0, 'amazon_wish_list', 'Amazon Wish List Button');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('AOL Mail', 0, 1, 0, 'aol_mail', 'AOL Mail Button');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Baidu', 0, 0, 0, 'baidu', 'Baidu Button');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Balatarin', 0, 1, 0, 'balatarin', 'Balatarin Button - A Persian language social and political link-sharing website aimed primarily at Iranian audiences.');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('BibSonomy', 0, 1, 0, 'bibsonomy', 'BibSonomy Button - A social bookmarking and publication sharing system.');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Bitty Browser', 0, 1, 0, 'bitty_browser', 'Bitty Browser Button - Helps you keep track of your favorite Web stuff by enalbing navigable windows directly within your favorite sites.');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Blinklist', 0, 1, 0, 'blinklist', 'Blinklist Button - Blinklist provides information and reviews on web and mobile start-ups.');",
    ...
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Bookmarks.fr', 0, 1, 0, 'bookmarks_fr', 'Bookmarks.fr Button - Bookmarks on your site targeted at French users.');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Box.net', 0, 1, 0, 'box_net', 'Box.net Button - Share via Box.net');",
    ...
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Buffer', 0, 1, 0, 'buffer', 'Buffer Button - An application for the web designed to manage accounts in social networks, by allowing a user to schedule posts to Twitter, Facebook and other social networks.');",
    "INSERT INTO {$_TABLES['ss_services']} (`name`, `priority`, `excluded`, `button`, `code`, `description`) VALUES('Care2 News', 0, 1, 0, 'care2_news', 'Care2 News Button - A social networking site designed to connect activists from around the world with other individuals, organizations and businesses making an impact.');",
